...
then
    ...
    docker run --rm=true -v "$(pwd):/home/user/module" -v "$KERNEL_PATH:/home/user/linux_camp" indent-x86 /home/user/linux_camp/scripts/Lindent /home/user/module/$INDENT_TARGET 
